...
from crew import ProjetoCarrera
...
def run():
    ...
    try:
        ProjetoCarrera().crew().kickoff(inputs=inputs)
...
def train():
    ...
    try:
        ProjetoCarrera().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
def replay():
    ...
    """
    try:
        ProjetoCarrera().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        ProjetoCarrera().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
